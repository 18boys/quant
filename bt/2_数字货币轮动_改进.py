...
# 读取数据
df_coin1 = pd.read_csv('BTCUSD-1d.data', encoding='gbk', parse_dates=['candle_end_time'])
df_coin2 = pd.read_csv('ETHUSD-1d.data', encoding='gbk', parse_dates=['candle_end_time'])
...
# 保存文件
print(df.tail(10))
df.to_csv('数字货币轮动_改进.data', encoding='gbk', index=False)
